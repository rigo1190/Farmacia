<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="wfStocksMinimos.aspx.cs" Inherits="SIP.Formas.Inventarios.wfStocksMinimos" %>
...
<div class="container" id="divMain" runat="server">
   ...
   <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <div class="row">
                <div class="col-md-4"><h3 class="panel-title">Stocks Mínimos...</h3></div>
