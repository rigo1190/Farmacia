<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="wfFPSfactores.aspx.cs" Inherits="SIP.Formas.Catalogos.wfFPSfactores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divBtnNuevo" runat="server">
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">F.P.S.  :: Registre en los campos los datos solicitados</h3>
        </div>
