<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="wfPresentaciones.aspx.cs" Inherits="SIP.Formas.Catalogos.wfPresentaciones" %>
...
<div class="container">
    ...
    <div id="divBtnNuevo" runat="server">
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Presentaciones :: Registre en los campos los datos solicitados</h3>
        </div>
