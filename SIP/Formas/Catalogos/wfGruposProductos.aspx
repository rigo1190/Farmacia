<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="wfGruposProductos.aspx.cs" Inherits="SIP.Formas.Catalogos.wfGruposProductos" %>
...
<div class="container" id="divMain" runat="server">
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Grupo de Productos</h3>
        </div>
    ...
    <div id="divBtnNuevo" runat="server">
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Grupo de Productos  :: Registre en los campos los datos solicitados</h3>
        </div>
