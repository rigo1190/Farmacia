...
{
    public partial class wfPresentaciones : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            this.grid.DataSource = uow.PresentacionesBL.Get();
            this.grid.DataBind();
        }
        ...
        protected void imgBtnEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Presentaciones obj = uow.PresentacionesBL.GetByID(int.Parse(_ElId.Text));
        ...
        protected void imgBtnEliminar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            lista = uow.ArticulosBL.Get(p => p.PresentacionId == obj.Id).ToList();
            ...
            {
                uow.PresentacionesBL.Delete(obj);
                uow.SaveChanges();
                BindGrid();
            }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            List<Presentaciones> lista;

            String mensaje = "";


            if (_Accion.Text == "Nuevo")
                obj = new  Presentaciones();
            else
                obj = uow.PresentacionesBL.GetByID(int.Parse(_ElId.Text));
            ...
            { //update
                ...
                lista = uow.PresentacionesBL.Get(p => p.Clave == obj.Clave && p.Id != xid).ToList();
                if (lista.Count > 0)
                    uow.Errors.Add("La Clave que capturo ya ha sido registrada anteriormente, verifique su información");



                lista = uow.PresentacionesBL.Get(p => p.Nombre == obj.Nombre && p.Id != xid).ToList();
                if (lista.Count > 0)
                    uow.Errors.Add("La Descripción que capturo ya ha sido registrada anteriormente, verifique su información");


                uow.PresentacionesBL.Update(obj);
