<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="wfUsuarios.aspx.cs" Inherits="SIP.Formas.Catalogos.wfUsuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
        ...
        <asp:GridView Height="25px" ShowHeaderWhenEmpty="true" CssClass="table" ID="grid" DataKeyNames="Id" AutoGenerateColumns="False" runat="server">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Login" ItemStyle-CssClass="col-md-1">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Nivel" ItemStyle-CssClass="col-md-1">
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("Nivel") %>'></asp:Label>
                        </ItemTemplate>                        
                    </asp:TemplateField>
    ...
    <div id="divBtnNuevo" runat="server">
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Usuarios  :: Registre en los campos los datos solicitados</h3>
        </div>
                ...
                <div class="form-group"">
                    ...
                    <input type="text" class="input-sm required form-control" id="txtLogin" runat="server" style="text-align: left; width:200px; align-items:flex-start" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLogin" ErrorMessage="El campo login es obligatorio" ValidationGroup="validateX">*</asp:RequiredFieldValidator>
                ...
                <div class="form-group"">
                    ...
                    <asp:TextBox CssClass="form-control" runat="server" ID="txtPassword" TextMode="Password" Width="200px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" ErrorMessage="El campo Password es obligatorio" ValidationGroup="validateX">*</asp:RequiredFieldValidator>
