<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="wfMarcas.aspx.cs" Inherits="SIP.Formas.Catalogos.wfMarcas" %>
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
        <div class="panel-heading">
             <div class="row">
                ...
                <div class="col-md-2"><a href="<%=ResolveClientUrl("~/Formas/Catalogos/wfLaboratorios.aspx") %>">Regresar</a></div>
             </div>
        </div>
