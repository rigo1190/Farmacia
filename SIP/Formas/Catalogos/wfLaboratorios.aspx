<%@ Page Title="" Language="C#" MasterPageFile="~/NavegadorPrincipal.Master" AutoEventWireup="true" CodeBehind="wfLaboratorios.aspx.cs" Inherits="SIP.Formas.Catalogos.wfLaboratorios" %>
...
<div class="container">
    ...
    <div id="divDatos" runat="server" class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Laboratorios</h3>
        </div>
        ...
        <asp:GridView Height="25px" ShowHeaderWhenEmpty="true" CssClass="table" ID="grid" DataKeyNames="Id" AutoGenerateColumns="False" runat="server">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nombre" ItemStyle-CssClass="col-md-10">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgBtnMarcas" ToolTip="Subprogramas" runat="server" ImageUrl="~/img/Sub.png" OnClick="imgBtnMarcas_Click"/>
    ...
    <div id="divBtnNuevo" runat="server">
       ...
       <div id="divCaptura" runat="server" class="panel panel-success">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Laboratorios :: Registre en los campos los datos solicitados</h3>
        </div>
